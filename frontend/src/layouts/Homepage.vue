    ...
    <header class="lg:h-24 flex lg:flex-row flex-col items-center z-30 w-full md:absolute">
      <div class="container mx-auto px-6 flex items-center justify-between py-10">
        ...
        >
          ...
          <span class="text-xs ml-3 mt-1"> carlosmls.crc@gmail.com </span>
        </div>
        <div class="flex items-center">
          ...
          >
            ...
            <g-link class="py-2 px-6 flex hover:text-black" to="/blog"
              >Blog</g-link
            >
            <g-link class="py-2 px-6 flex hover:text-black" to="/contact"
              >Contact</g-link
            >
          </nav>
